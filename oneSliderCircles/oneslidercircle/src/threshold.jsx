...
class NormalCurve extends Component {
    ...
    onChange1(e) {
      ...
      this.setState({rect1Width : 400*this.state.displayArr1[e.target.value]})
      this.setState({rect2Width: 400*this.state.displayArr2[e.target.value]})
    }
    onChange2(e) {
      this.setState({rect3Width : 400*this.state.displayArr3[e.target.value]})
      this.setState({rect4Width: 400*this.state.displayArr4[e.target.value]})
      this.setState({ [e.target.name]: e.target.value })
    }
    ...
    return (
      <div>
        ...
        {[...this.state.displayArr5].map(
          (b, index) =>
            (this.textReturn(this.state.refArr5[index], 265, b))
        )}
        ...
        <input type="range" min={this.state.minVal} max={this.state.maxVal} 
              ...
              style={{ width: 200 + this.state.width, left:115}}/>
            <input type = "range" min = {this.state.minVal} max = {this.state.maxVal}
